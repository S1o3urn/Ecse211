...
public class EV3Navigation {
	...
	public static void main(String[] args) {
		...
		SensorModes ultrasonicSensor = new EV3UltrasonicSensor(ultrasonicSensorPort);		// ultrasonicSensor being the instance
		SampleProvider ultrasonicDistance = ultrasonicSensor.getMode("Distance");			// ultrasonicDistance provides samples from this instance
		float[] ultrasonicData = new float[ultrasonicDistance.sampleSize()];				// ultrasonicData is the buffer in which data are returned
